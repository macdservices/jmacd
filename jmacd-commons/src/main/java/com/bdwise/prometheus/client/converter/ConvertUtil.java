...
public abstract class ConvertUtil {
	...
	public static DefaultAlertManagerResult convertAlertManagerResultString(String jsonString) {
		Gson gson = new GsonBuilder()
				.registerTypeAdapter(DefaultAlertManagerResult.class, new TypeAdapter<DefaultAlertManagerResult>() {
	...
	public static DefaultTargetResult convertTargetResultString(String jsonString) {
		Gson gson = new GsonBuilder()
				.registerTypeAdapter(DefaultTargetResult.class, new TypeAdapter<DefaultTargetResult>() {
	...
	public static DefaultConfigResult convertConfigResultString(String jsonString) {
		Gson gson = new GsonBuilder()
				.registerTypeAdapter(DefaultConfigResult.class, new TypeAdapter<DefaultConfigResult>() {
	...
	public static DefaultLabelResult convertLabelResultString(String jsonString) {
		Gson gson = new GsonBuilder()
				.registerTypeAdapter(DefaultLabelResult.class, new TypeAdapter<DefaultLabelResult>() {
	...
	public static DefaultSeriesResult convertSeriesResultString(String jsonString) {
		Gson gson = new GsonBuilder()
				.registerTypeAdapter(DefaultSeriesResult.class, new TypeAdapter<DefaultSeriesResult>() {
...
//							System.out.println(seriesData);
	...
	public static <T extends Data> DefaultQueryResult<T> convertQueryResultString(String jsonString) {
		Gson gson = new GsonBuilder()
				.registerTypeAdapter(DefaultQueryResult.class, new TypeAdapter<DefaultQueryResult<T>>() {
					@Override
